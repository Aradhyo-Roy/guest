...
function sort(){
    ...
    function so(){
        var guest_list=document.getElementById("guest_name").value;
        name_of_people.push(guest_list);
        document.getElementById("display_name_as_a_coloumn").innerHTML=guest_list;
    }